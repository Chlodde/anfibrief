...
\ifml
    \item[Pub Crawl 1 -- TBA]~\\ %-- Friday, April 11th \YEAR, ca. 19:00 Uhr, Stiftskirche]~\\
...
\else
    \item[Kneipentour 1 -- TBA]~\\  %-- Freitag, 11. April \YEAR, ca. 19:00 Uhr, Stiftskirche]~\\
...
\ifml
\item[Pub Crawl 2  -- TBA]~\\  %-- Tuesday, April 15th \YEAR, ca. 19:00 Uhr, Stiftskirche]~\\
   ...
   \seticon{faBus}~\textbf{bus stop:} Neckarbrücke or Nonnenhaus (lines 1--21)
\else
\item[Kneipentour 2  -- TBA]~\\  %-- Dienstag, 15. April \YEAR, ca. 19:00 Uhr, Stiftskirche]~\\
